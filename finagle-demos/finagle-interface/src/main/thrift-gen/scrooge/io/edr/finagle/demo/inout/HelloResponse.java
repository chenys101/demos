...
public class HelloResponse implements TBase<HelloResponse, HelloResponse._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("HelloResponse");

  private static final TField BASE_RESP_FIELD_DESC = new TField("baseResp", TType.STRUCT, (short)1);
  private static final TField VALUE_FIELD_DESC = new TField("value", TType.STRING, (short)2);


  public io.edr.finagle.demo.inout.common.BaseResponse baseResp;
  public String value;
  ...
  static {
    ...
    tmpMap.put(_Fields.BASE_RESP, new FieldMetaData("baseResp", TFieldRequirementType.DEFAULT,
      new StructMetaData(TType.STRUCT, io.edr.finagle.demo.inout.common.BaseResponse.class)));
    tmpMap.put(_Fields.VALUE, new FieldMetaData("value", TFieldRequirementType.DEFAULT,
      new FieldValueMetaData(TType.STRING)));
    metaDataMap = Collections.unmodifiableMap(tmpMap);
    FieldMetaData.addStructMetaDataMap(HelloResponse.class, metaDataMap);
  }
  ...
  public HelloResponse(
    io.edr.finagle.demo.inout.common.BaseResponse baseResp,
    String value)
  {
    this();
  ...
  public HelloResponse(HelloResponse other) {
    if (other.isSetBaseResp()) {
      this.baseResp = new io.edr.finagle.demo.inout.common.BaseResponse(other.baseResp);
    }
    if (other.isSetValue()) {
  ...
  public io.edr.finagle.demo.inout.common.BaseResponse getBaseResp() {
    return this.baseResp;
  }

  public HelloResponse setBaseResp(io.edr.finagle.demo.inout.common.BaseResponse baseResp) {
    this.baseResp = baseResp;
  ...
  public HelloResponse setValue(String value) {
    this.value = value;
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case BASE_RESP:
      if (value == null) {
        ...
        setBaseResp((io.edr.finagle.demo.inout.common.BaseResponse)value);
      }
      break;
    case VALUE:
      if (value == null) {
  ...
  public int compareTo(HelloResponse other) {
    ...
    HelloResponse typedOther = (HelloResponse)other;
      ...
      switch (field.id) {
        case 1: // BASE_RESP
          if (field.type == TType.STRUCT) {
            this.baseResp = new io.edr.finagle.demo.inout.common.BaseResponse();

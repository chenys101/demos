...
public class StringResponse implements TBase<StringResponse, StringResponse._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("StringResponse");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(StringResponse.class, metaDataMap);
  }
   ...
   */
  public StringResponse(StringResponse other) {
  ...
  public StringResponse deepCopy() {
  ...
  public StringResponse setBaseResp(BaseResponse baseResp) {
    this.baseResp = baseResp;
  ...
  public StringResponse setValue(String value) {
    this.value = value;
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof StringResponse)
      return this.equals((StringResponse)that);
    return false;
  }

  public boolean equals(StringResponse that) {
    if (that == null)
      return false;
  ...
  public int compareTo(StringResponse other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    StringResponse typedOther = (StringResponse)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("StringResponse(");
    boolean first = true;
    sb.append("baseResp:");
    if (this.baseResp == null) {
      sb.append("null");

...
public class I64Response implements TBase<I64Response, I64Response._Fields>, java.io.Serializable, Cloneable {
  private static final TStruct STRUCT_DESC = new TStruct("I64Response");
  ...
  static {
    ...
    FieldMetaData.addStructMetaDataMap(I64Response.class, metaDataMap);
  }
   ...
   */
  public I64Response(I64Response other) {
  ...
  public I64Response deepCopy() {
    return new I64Response(this);
  }
  ...
  public I64Response setBaseResp(BaseResponse baseResp) {
    this.baseResp = baseResp;
  ...
  public I64Response setValue(long value) {
    this.value = value;
    setValueIsSet(true);
  ...
  public boolean equals(Object that) {
    if (that == null)
      return false;
    if (that instanceof I64Response)
      return this.equals((I64Response)that);
    return false;
  }

  public boolean equals(I64Response that) {
    if (that == null)
      return false;
  ...
  public int compareTo(I64Response other) {
    if (!getClass().equals(other.getClass())) {
      return getClass().getName().compareTo(other.getClass().getName());
    }

    int lastComparison = 0;
    I64Response typedOther = (I64Response)other;
  ...
  public String toString() {
    StringBuilder sb = new StringBuilder("I64Response(");
    boolean first = true;
    sb.append("baseResp:");
    if (this.baseResp == null) {
      sb.append("null");
